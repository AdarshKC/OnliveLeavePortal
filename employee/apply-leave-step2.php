...
@keyframes loade-01 {
    ...
    <div class="card-content">
        ...
        <div>
            <h5><strong><?php echo $leavetype; ?></strong></h5>
            ...
            <h5><strong>Description:</strong> <?php echo $to; ?> </h5>
            <h5><strong>:</strong> <?php echo $to; ?> </h5>
    ...
    ?>
    <span class="stats-counter"><span
    class="counter"><?php echo htmlentities($leavtypcount-$dptcount);?></span></span>
