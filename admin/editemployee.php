...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Employee Leave History</title>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php 
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves where empid=:eid AND Status IN(1,2) ORDER BY PostingDate DESC";
